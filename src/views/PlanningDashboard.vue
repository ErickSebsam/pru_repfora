<template>
  <div>
    ...
    <!-- ─── ADMINISTRATOR / COORDINATOR / PROGRAMMER VIEW (5 Cards componentizadas) ─── -->
    ...
    <div v-else class="row justify-center my-row" :class="$q.screen.width < 500 ? 'q-px-none' : 'q-px-md'">
      <!-- Card 1: Nueva Planeación (componente Card) -->
      <div class="col-12 col-md-5 q-my-md flex" :class="$q.screen.width < 500 ? 'q-px-none' : 'q-px-lg'">
        <Card
          title="Nueva Planeación"
          image="/images/calendar.png"
          route="/extract"
          description="Cargue de programas oficiales, cruce automático con proyecto formativo y diseño del plan de sesiones."
        />
      </div>
...
// ── Cards del panel de administración (componentizadas) ──
const adminCards = ref([
  {
    title: 'Nueva Planeación',
    image: '/images/calendar.png',
    route: '/extract',
    roles: ['PROGRAMADOR', 'COORDINADOR', 'ADMIN'],
  },
  {
    title: 'Programador',
