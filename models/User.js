...
const UserSquema = new Schema(
  {
    ...
    // Preferencias de notificación por correo para complementarias.
    // Solo aplica a roles COORDINADOR y PROGRAMADOR.
    notificacionesComplementarias: {
      habilitado: { type: Boolean, default: true },
      // null = usa el email registrado del usuario; string = email destino personalizado (p.ej. email de área)
