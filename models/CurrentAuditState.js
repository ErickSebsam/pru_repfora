...
// Aprendiz excluido por novedad (una fila por aprendiz/RAP)
// Reúsa info del outcome + datos del aprendiz + tipo de novedad
const NewsExcludedItemSchema = new Schema({
  scheduleId: { type: Schema.Types.ObjectId, ref: 'Schedules' },
  ficheNumber: String,
  ficheId: { type: Schema.Types.ObjectId, ref: 'Fiche' },
  outcomeText: String,
