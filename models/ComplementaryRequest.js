...
const ComplementaryRequestSquema = new Schema(
  {
    ...
    // Habilitado temporalmente cuando el admin/coordinador aprueba una solicitud
    // de ampliacion. Permite al instructor reprogramar su ficha (PUT /schedule/:id/reschedule).
    // Vuelve a false automáticamente al guardar la reprogramacion.
    puedeReprogramar: {
      type: Boolean,
      default: false,
    },
